...
namespace DoctorAppoinment
{
    public partial class patientinfo : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd1 = new SqlCommand("INSERT INTO patientInfo (pid,name,age,phoneNo,Gender,address) VALUES ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "', '" + textBox4.Text + "','" + comboBox1.Text + "', '" + textBox5.Text + "')", cn1);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd1 = new SqlCommand("update  patientInfo set name='" + textBox2.Text + "',age='" + textBox3.Text + "',phoneNo='" + textBox4.Text + "',Gender='" + comboBox1.Text + "',address='" + textBox5.Text + "' where pid='"+ textBox1.Text +"' ", cn1);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection cn1 = new SqlConnection(cns);
            cn1.Open();
            SqlCommand cmd1 = new SqlCommand("DELETE FROM patientInfo  where pid='" + textBox1.Text + "'", cn1);
